...
out_gdb = r'F:\Suicide_Vs_Population\LITS_20200729\Suicide_R_2008-2017_2k_KDs.gdb'
...
name_base = 'Rescale_2k_KD_Suicide_Res_08_17'
...
with arcpy.EnvManager(scratchWorkspace=out_gdb, workspace=out_gdb):
    ...
    try:
        for key, where_clause in theme_filters.items():
            ...
            print("Finished Con - " + out_name + " - Max Value: " + str(max_val))
