                ...
                for cellsize in cellsizes:
                    for age, ageRange in ages.items():
                        ...
                        if not arcpy.Exists(OutputKDr):
                            ...
                            kd_result = KernelDensity(in_features=OutputEvents,
                        ...
                        if not arcpy.Exists(OutputKDv):
                            arcpy.AddMessage("Converting to Integer KD: {} - {}".format(OutputKDr,
                                                                                        time.strftime("%X")))
                            txtFile.write("Converting to Integer KD: {} - {}{}".format(OutputKDr,
                                                                                       time.strftime("%X"),
                                                                                       "\n"))
