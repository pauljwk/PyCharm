...
out_gdb = r'F:\Suicide_Vs_Population\LITS_20200729\Suicide_2008-2017_KDs.gdb'
...
name_base = 'C_Rescale_1k_KD_Suicide_Inc_08_17'
...
with arcpy.EnvManager(scratchWorkspace=out_gdb, workspace=out_gdb):
    ...
    try:
        for key, where_clause in theme_filters.items():
            ...
            #out_raster = arcpy.sa.RescaleByFunction(in_raster=con_path, transformation_function=transform_function, from_scale=0, to_scale=20)
            ...
            with arcpy.EnvManager(compression="NONE", pyramid="NONE"):
                ...
                #out_raster = arcpy.sa.RescaleByFunction("Rescale_1k_KD_Suicide_Inc_08_17_Total_PCON",
                #                                        "LINEAR 0 60.44379806518555 0 # 60.44379806518555 #", 0, 20);

                #out_raster.save(r"F:\Suicide_Vs_Population\LITS_20200729\Suicide_2008-2017_KDs.gdb\Rescale_RescCON")
